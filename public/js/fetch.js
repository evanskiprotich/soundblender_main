...
console.log("Fetching From Firestore has Started!");
    ...
    .then((snapshot) => {
      ...
      if (songs.length == 0) {
        ...
        if (str == "") {
          ...
          document.getElementById("artistTitle").innerHTML =
            artist + " ft. " + featured;
        }
...
function renderList(docc) {
  ...
  if (docc.data().featured == "") {
    ...
    artistDiv.textContent =
      docc.data().artist + " ft. " + limit(docc.data().featured, 40) + "...";
  }
